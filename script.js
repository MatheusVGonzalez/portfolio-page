...
const i18n = {
    ...
    'cv.en.combined': 'Resume — English (Salesforce + Web)',
    'cv.sf.pt': 'Salesforce — Portuguese',
    'cv.web.pt': 'Web Developer — Portuguese',
        'hero.photoAlt': 'Professional profile photo of Matheus Gonzalez',
        'about.title': 'ABOUT ME',
    'about.description': 'Salesforce Developer and Consultant experienced in Apex, SOQL, Triggers, Lightning Web Components (LWC), Flow Builder, REST integrations, and data modeling. Salesforce Platform Foundations certified, Trailhead Ranger, and preparing for Platform Developer I. I work at C3C Software developing Apex and LWC, building flows, integrations, requirements analysis, defining business rules, and supporting the implementation of scalable solutions for clients. I have 2+ years of full‑stack web development experience and international experience in Canada, where I completed a Web Development co‑op and achieved fluency in English.',
        'about.years': 'Years of Experience Full-Stack',
        'about.projects': 'Points Trailhead',
    ...
    'exp.item3.date': 'NOV/2025 - Present',
    'exp.item3.title': 'Salesforce Consultant (Intern)',
    'exp.item3.company': 'C3C Software',
    'exp.item3.desc': 'Joined C3C Software as a Salesforce Consultant intern, contributing to Apex classes and triggers, Lightning Web Components, Flow automation, SOQL queries, and REST integrations. Worked on implementing solutions for clients, debugging integrations, and assisting in technical design and deployment.',
    // Education items
    ...
    'edu.item8.title': 'Trailhead – Salesforce Ranger',
    'edu.item8.inst': 'Salesforce Trailhead',
    'edu.item8.period': 'Ongoing',
    'edu.item8.desc': '100+ badges, 50,000+ points, 5+ superbadges, Ranger level. Focused on Apex, SOQL, Lightning Web Components, and automation.',
    'edu.capstone.title': 'Web Development Capstone Certificate',
    'edu.capstone.inst': 'Tamwood International College — Capstone',
    'edu.capstone.period': 'Completed OCT/2025',
    'edu.capstone.desc': '7-month capstone certificate in Web Development covering advanced front-end and back-end projects, APIs, deployment, and a final portfolio project demonstrating full-stack skills.',
    // University (new)
    'edu.uni.title': 'Computer Engineering (Bachelor)',
    'edu.uni.inst': 'UNIVAP — Universidade do Vale do Paraíba',
    'edu.uni.period': 'JAN/2026 — DEC/2030',
    ...
    'cv.en.combined': 'Currículo — Inglês (Salesforce + Web)',
    ...
    'about.description': 'Desenvolvedor e Consultor Salesforce com experiência em Apex, SOQL, Triggers, LWC, Flow Builder, integrações REST e modelagem de dados. Certificado Salesforce Platform Foundations, Trailhead Ranger e em preparação para Platform Developer I. Atuo na C3C Software com desenvolvimento em Apex e LWC, construção de fluxos, integrações, análise de requisitos, definição de regras de negócio e apoio na implementação de soluções escaláveis para clientes. Possuo 2+ anos de experiência em desenvolvimento web full-stack e experiência internacional no Canadá, onde realizei um Co‑op em Web Development e desenvolvi fluência em inglês.',
        'about.years': 'Anos de Experiência Full-Stack',
        'about.projects': 'Pontos Trailhead',
    ...
    'exp.item3.date': 'NOV/2025 - Presente',
    'exp.item3.title': 'Consultor Salesforce - Estágio',
    'exp.item3.company': 'C3C Software',
    'exp.item3.desc': 'Iniciei na C3C Software como estagiário em consultoria Salesforce, contribuindo com classes Apex e triggers, Lightning Web Components (LWC), automações com Flow, consultas SOQL e integrações REST. Apoiei implementações para clientes, depuração de integrações e suporte no desenho técnico e deploy.',
    // Education items
    ...
    'edu.item8.desc': '100+ emblemas, 50.000+ pontos, 5+ superbadges e nível Ranger. Foco em Apex, SOQL, Lightning Web Components e automação.',
    'edu.capstone.title': 'Certificado Capstone em Web Development',
    'edu.capstone.inst': 'Tamwood International College — Capstone',
    'edu.capstone.period': 'Concluído OUT/2025',
    'edu.capstone.desc': 'Certificado capstone de 7 meses em Web Development cobrindo projetos avançados de front-end e back-end, APIs, deploy e um projeto final de portfólio demonstrando competências full‑stack.',
    // Universidade (novo)
    'edu.uni.title': 'Engenharia da Computação (Bacharelado)',
    'edu.uni.inst': 'UNIVAP — Universidade do Vale do Paraíba',
    'edu.uni.period': 'JAN/2026 — DEZ/2030',
